...
function PrivacyPolicy() {
  ...
  return (
    <div className="bg-neutral-900 w-full h-full py-28 ">
      <div className="bg-neutral-50 px-20 w-[90%] md:w-[80%] lg:w-[70%] max-w-4xl md:py-16 mx-auto">
        <div className="flex flex-col  ">
          <h1 className="font-bold">
            Privacy Policy for Ironclad Solutions LLC
          </h1>
          ...
          <div className="flex flex-col gap-y-6 md:gap-y-8">
            ...
            <p className="mb-4 leading-relaxed">
              Welcome to Ironclad Solutions LLC. Your privacy is important to
            ...
            <ol className="list-decimal leading-relaxed">
              ...
              <ul className="pl-4 list-disc">
                <li>
                  Contact you via phone call, text message, or email regarding
                  our services, promotions, and offers
                </li>
                <li>
              ...
              <ul className="pl-4 list-disc">
                <li>
                  Business partners and affiliates for marketing, promotional,
                  or operational purposes
                </li>
                <li>
                  Authorized associates, consultants, and representatives
                  working with or on behalf of Ironclad Solutions LLC
                </li>
                <li>
              ...
              <p className="mt-2 leading-relaxed">
                By submitting your contact information, you agree that your
                mobile number and other data may be shared with approved
                partners and affiliates for relevant marketing and promotional
                communication.
              </p>
              <p className="leading-relaxed">
              ...
              <p className="leading-relaxed">
                ...
                on this page with the effective date. Continued use of our
