  ...
  return (
    <div className="bg-neutral-50 w-full ">
      <div className="flex flex-col w-[90%] md:w-[80%] lg:w-[70%] max-w-4xl mx-auto py-12 md:py-16">
        <h1 className="text-4xl md:text-5xl font-bold py-6 md:py-8">
          Privacy Policy
        </h1>
        ...
        <div className="flex flex-col gap-y-6 md:gap-y-8">
          ...
          <h3 className="text-2xl md:text-3xl font-semibold mb-4 text-neutral-800">
            Interpretation
          </h3>
          <p className="mb-8 leading-relaxed">
          ...
          <ul className="list-disc pl-5 mb-8 space-y-2">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Ironclad Solutions LLC, United
                States.
              </p>
            </li>
            <li>
